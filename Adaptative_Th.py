...
adap_th(img1,row,cols,2,20)
adap_th(img2,row,cols,5,20)
adap_th(img3,row,cols,10,20)
adap_th(img4,row,cols,15,20)


f, axarr = plt.subplots(2,2)
axarr[0,0].imshow(cv2.cvtColor(img1, cv2.COLOR_GRAY2RGB))
axarr[0,0].set_title("Th C=2, rango 20")
axarr[0,1].imshow(cv2.cvtColor(img2, cv2.COLOR_GRAY2RGB))
axarr[0,1].set_title("Th C=5, rango 20")
axarr[1,0].imshow(cv2.cvtColor(img3, cv2.COLOR_GRAY2RGB))
axarr[1,0].set_title("Th C=10, rango 20")
axarr[1,1].imshow(cv2.cvtColor(img4, cv2.COLOR_GRAY2RGB))
axarr[1,1].set_title("Th C=15, rango 20")
plt.show()
